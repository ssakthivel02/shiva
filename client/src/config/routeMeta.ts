...
export const routeMetaByPath: Readonly<Record<string, RouteMeta>> = {
  ...
  "/explore": {
    title: "Explore the Knowledge Universe — Shiva",
  ...
  "/search": {
    ...
    description: "Search the local Shiva collection in Tamil, English and common transliteration aliases while keeping record type and editorial status visible.",
    schemaType: "SearchResultsPage",
    label: "Search",
  },
  "/scriptures": {
    title: "Scripture Learning Library — Shiva",
  ...
  "/bhagavad-gita": {
    title: "Bhagavad Gita Learning Path — Shiva",
  ...
  "/rig-veda": {
    title: "Rig Veda Starter Records — Shiva",
  ...
  "/upanishads": {
    title: "Upanishad Learning Overview — Shiva",
  ...
  "/deities": {
    title: "Deity Encyclopedia Pathways — Shiva",
  ...
  "/temples": {
    title: "Temple Journeys and Context — Shiva",
  ...
  "/rishis": {
    title: "Rishis and Lineage Context — Shiva",
  ...
  "/festivals": {
    title: "Festival Context and Regional Practice — Shiva",
  ...
  "/glossary": {
    title: "Bilingual Vedic and Cultural Glossary — Shiva",
  ...
  "/life-guidance": {
    title: "Reflective Life Guidance — Shiva",
  ...
  "/guidance": {
    title: "Reflective Guidance — Shiva",
    description: "Open the bounded Shiva life-guidance pathway.",
    robots: "noindex,follow",
    schemaType: "WebPage",
    label: "Guidance alias",
  },
  "/learning": {
    title: "Pressure-Free Learning Paths — Shiva",
  ...
  "/kids": {
    title: "Family-Safe Kids Learning — Shiva",
  ...
  "/collection-status": {
    title: "Collection Status and Review Boundaries — Shiva",
    description: "Review what Shiva currently contains, which records are editorial orientation, what still needs source review and which limits remain explicit.",
    schemaType: "CollectionPage",
    label: "Collection Status",
  },
  "/audio": {
    title: "Audio Learning Preview — Shiva",
    description: "Review the Shiva audio-learning boundary, local playback state and the distinction between available interface controls and reviewed recordings.",
    schemaType: "CollectionPage",
    label: "Audio",
  },
  "/library": {
    title: "Browser-Local Study Library — Shiva",
  ...
  "/about": {
    title: "About Shiva",
    description: "Learn the purpose, editorial method, bilingual learning approach and product boundaries behind the Shiva Vedic knowledge experience.",
    schemaType: "AboutPage",
    label: "About",
  },
  "/sources": {
    title: "Sources and Editorial Method — Shiva",
    description: "Review how Shiva distinguishes primary text, translation, editorial overview, interpretation, generated explanation and unresolved source work.",
    schemaType: "WebPage",
    label: "Sources",
  },
  "/privacy": {
    title: "Privacy Policy — Shiva",
    description: "Read how the Shiva static website handles browser-local data, operational requests and the limits of account or cloud synchronisation claims.",
    schemaType: "WebPage",
    label: "Privacy",
  },
  "/terms": {
    title: "Terms of Use — Shiva",
    description: "Review the educational, cultural and devotional-use terms, content boundaries, local-data limitations and acceptable use of Shiva.",
    schemaType: "WebPage",
    label: "Terms",
  },
  "/delete-account": {
    title: "Delete Account Request — Shiva",
  ...
  "/delete-data": {
    title: "Delete Data Request — Shiva",
  ...
  "/disclaimer": {
    title: "AI and Guidance Disclaimer — Shiva",
  ...
  "/contact": {
    title: "Contact and Corrections — Shiva",
    description: "Use the Shiva contact pathway for corrections, source suggestions, accessibility feedback, privacy requests and operational enquiries.",
    schemaType: "ContactPage",
    label: "Contact",
  },
  "/status": {
    title: "System Status and Release Evidence — Shiva",
    description: "Review current Shiva release identity, health evidence, production boundaries, direct-route support and public operational endpoints.",
    schemaType: "WebPage",
    label: "System Status",
  },
};
...
export const notFoundMeta: RouteMeta = {
  title: "Page Not Found — Shiva",
  description: "The requested Shiva route was not found. Return to the knowledge universe, search the local collection or open a well-marked learning path.",
  robots: "noindex,follow",
  schemaType: "WebPage",
...
export function resolveRouteMeta(location: string): RouteMeta {
  ...
  if (path.startsWith("/deities/")) {
    ...
    return {
      title: `${name} Editorial Context — Shiva`,
      description: `Explore the Shiva editorial orientation pathway for ${name}, with names, symbolism, related learning and source-review boundaries kept visible.`,
      image: defaultImage,
      schemaType: "WebPage",
